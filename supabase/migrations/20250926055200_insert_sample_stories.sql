-- Insert sample stories data (using updated column names)
INSERT INTO stories (title, excerpt, article, date, category, sport_id, photographer, journalist) VALUES
(
  'Men''s Basketball Team Secures Championship Victory',
  'The UTSC Maroons Men''s Basketball team delivered an outstanding performance in the championship game, securing a decisive victory with a final score of 78-65.',
...
(
  ...
  'In an electrifying semifinal match, the Women''s Volleyball team showcased their skill and determination, advancing to the championship finals with a thrilling 3-2 victory.',
...
(
  ...
  'The Men''s Soccer team concluded their most successful season in program history, finishing with an impressive 12-2 record.',
